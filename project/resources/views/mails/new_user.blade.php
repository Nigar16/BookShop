                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div align="center" style="line-height:10px">
                                                    <h1><span class="text-dark">Book</span><span class="text-primary">Shop</span></h1></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div align="center" style="line-height:10px"><img
                                                        alt="I'm an image" src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1361/Img4_2x.jpg"
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 16px; text-align: center;">
																			<span
                                                                                style="font-size:30px;color:#2b303a;"><strong>Ailəmizə
																					xoş gəldiniz {{ $data["name"] }} !</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <td class="column"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                style="padding-top:0px;padding-bottom:0px;border-top:0px;border-bottom:0px;width:580px;">
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                       class="divider_block" role="presentation"
                                                       style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                       width="100%">
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 16px; text-align: center;">
																						<span
                                                                                            style="color:#2b303a;font-size:18px;"><strong>İstifadəçi
																								e-mailiniz</strong></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 16px; text-align: center;">
																						<span
                                                                                            style="color:#1aa19c;font-size:14px;"><span
                                                                                                style=""><strong><span
                                                                                                        id="c1f8506a-cb1c-4c96-baa6-7b794fc70871"
                                                                                                        style="">{{ $data["email"] }}</span></strong></span></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div style="font-family: sans-serif">
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 16px; text-align: center;">
																						<span
                                                                                            style="color:#2b303a;font-size:18px;"><strong>Şifrəniz</strong></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="margin: 0; font-size: 16px; text-align: center;">
																						<span
                                                                                            style="color:#1aa19c;font-size:14px;"><span
                                                                                                style=""><strong>{{ $data["password"] }}</strong></span></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        <tr>
                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" style="line-height:10px"><img
                                                        ...
                                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1361/footer.png"
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            style="margin: 0; font-size: 14px; text-align: left;">
																			<span
                                                                                style="color:#95979c;font-size:12px;">BookShop
																				© 2021</span></p>
                                                    </div>
                                                </div>
                                            </td>
